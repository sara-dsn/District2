 ...
 */
final class Version20240219113823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD plat_id INT NOT NULL, CHANGE libelle libelle VARCHAR(50) NOT NULL, CHANGE image image VARCHAR(50) NOT NULL, CHANGE active active TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP plat_id, CHANGE libelle libelle VARCHAR(100) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE active active VARCHAR(10) NOT NULL');
